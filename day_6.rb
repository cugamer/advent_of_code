  ...
  if command == "on"
    board[start_row..end_row].each_index do |row_index|
      board[row_index][start_col..end_col].each_index do |col_index|
        board[row_index + start_row][col_index + start_col] = "n"
      end
    end
  elsif command == "off"
    board[start_row..end_row].each_index do |row_index|
      board[row_index][start_col..end_col].each_index do |col_index|
        board[row_index + start_row][col_index + start_col] = "f"
      end
    end
  elsif command == "toggle"
    board[start_row..end_row].each_index do |row_index|
      board[row_index][start_col..end_col].each_index do |col_index|
        if board[row_index + start_row][col_index + start_col] == "f"
          board[row_index + start_row][col_index + start_col] = "n"
        elsif board[row_index + start_row][col_index + start_col] == "n"
          board[row_index + start_row][col_index + start_col] = "f"
        end
      end
    end
...
input = ["toggle 489,959 through 759,964", "toggle 489,959 through 759,964"]
